...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:component:milvus:example:encoded world"]
#[doc(hidden)]
...
@\0\0s\x04\0\x0bhello-world\x01\0\x04\0\x18component:milvus/example\x04\0\x0b\x0d\
